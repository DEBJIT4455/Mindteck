    ...
    public partial class Mindteck : System.Web.UI.Page
    {
        ...
        protected void btnsv_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                com.CommandText = "INSERT INTO [dbo].[CustomerDetails] (Name,Adress,[Price Date],[Brand Name],State,Gender,Status,Time) VALUES (@Name,@Adress,@PriceDate,@BrandName,@State,@Gender,@Status,@Time)";
